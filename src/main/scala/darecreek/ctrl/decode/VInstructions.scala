...
object VInstructions {
  ...
  //wzw add custom instruction
  // def CUSTOM0_VS1        = BitPat("b1????????????????010?????0001011")
  // def CUSTOM0_VS1_VS2    = BitPat("b1????????????????011?????0001011")
  // def CUSTOM0_VD         = BitPat("b1????????????????100?????0001011")
  // def CUSTOM0_VD_VS1     = BitPat("b1????????????????110?????0001011")
  // def CUSTOM0_VD_VS1_VS2 = BitPat("b1????????????????111?????0001011")
  def IN_VC_V_VV         = BitPat("b001???0??????????000?????1111011")
  ...
  def IN_VC_V_V          = BitPat("b0010??0??????????111?????1111011")
}